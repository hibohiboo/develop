(function (scope) {
  ...
  */
  ...
  var author$project$Main$log = _Platform_outgoingPort('log', elm$json$Json$Encode$int);

  var elm$core$Platform$Cmd$batch = _Platform_batch;

  var author$project$Main$init = function (val) {
    return _Utils_Tuple2(0, elm$core$Platform$Cmd$batch(_List_fromArray([author$project$Main$log(0)])));
  };
  ...
  var author$project$Main$update = F2(function (msg, model) {
    if (msg.$ === 'Increment') {
      return _Utils_Tuple2(model + 1, elm$core$Platform$Cmd$batch(_List_fromArray([author$project$Main$log(model)])));
    } else {
      return _Utils_Tuple2(model - 1, elm$core$Platform$Cmd$batch(_List_fromArray([author$project$Main$log(model)])));
    }
  });
