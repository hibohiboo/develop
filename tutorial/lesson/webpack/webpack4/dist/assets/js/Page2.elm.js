...
(function (scope) {
  ...
  */
  ...
  var _Platform_worker = F4(function (impl, flagDecoder, debugMetadata, args) {
    return _Platform_initialize(flagDecoder, args, impl.as, impl.aA, impl.ay, function () {
      return function () {};
    });
  ...
  function _VirtualDom_makeCallback(eventNode, initialHandler) {
    function callback(event) {
      ...
      var currentEventNode = (stopPropagation && event.stopPropagation(), (tag == 2 ? value.b : tag == 3 && value.K) && event.preventDefault(), eventNode);
      var tagger;
      var i;
  ...
  var _Browser_element = _Debugger_element || F4(function (impl, flagDecoder, debugMetadata, args) {
    return _Platform_initialize(flagDecoder, args, impl.as, impl.aA, impl.ay, function (sendToApp, initialModel) {
      var view = impl.aC;
      /**/
      ...
      B: function (sendToApp) {
        ...
        return F2(function (domNode, event) {
          if (!event.ctrlKey && !event.metaKey && !event.shiftKey && event.button < 1 && !domNode.target && !domNode.download) {
            ...
            sendToApp(onUrlRequest(next && curr.ab === next.ab && curr.T === next.T && curr.Z.a === next.Z.a ? elm$browser$Browser$Internal(next) : elm$browser$Browser$External(href)));
          }
        });
      },
      as: function (flags) {
  ...
  var elm$browser$Browser$sandbox = function (impl) {
    return _Browser_element({
      ...
      aA: F2(function (msg, model) {
        return _Utils_Tuple2(A2(impl.aA, msg, model), elm$core$Platform$Cmd$none);
      }),
      aC: impl.aC
    });
  };
